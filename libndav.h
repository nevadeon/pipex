...
/*   Updated: 2024/05/17 10:50:28 by ndavenne         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
# ifndef BUFFER_SIZE
/**
 * @brief this buffer size is optimum for the average file but if you plan to
 * use gnl on lots of very small files or a gigantic one you might want to
 * change it in the header file or by recompiling with the flag
 * -D BUFFER_SIZE=<your buffer size>
 */
